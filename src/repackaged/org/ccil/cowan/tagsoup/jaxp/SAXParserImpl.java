...
package repackaged.org.ccil.cowan.tagsoup.jaxp;
...
public class SAXParserImpl
    extends SAXParser
{
    final repackaged.org.ccil.cowan.tagsoup.TagSoupParser parser;

    protected SAXParserImpl() // used by factory, for prototypes
    {
        super();
        parser = new repackaged.org.ccil.cowan.tagsoup.TagSoupParser();
    }
